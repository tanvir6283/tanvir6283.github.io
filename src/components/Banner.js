...
export const Banner = () => {
  ...
  const toRotate = [ "Electrical Engineer", "Software Engineer", "QA Engineer" ];
  const period = 2000;
...
Intended to be a result-oriented professional driven by the desire to excel business by utilizing new concepts, along with expertise in Technical Design, Operation, Project Management, Automation, Process Development, Risk Management as well as Technical planning & implementation.</p>
